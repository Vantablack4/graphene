...
dependencies {
    implementation("com.vantablack4.mc:graphene-ui:1.7.2-vb.5+mc26.1.2")
}
```
...
dependencies {
    implementation("com.vantablack4.mc:graphene-ui:1.7.2-vb.5+mc26.1.2")
    include("com.vantablack4.mc:graphene-ui:1.7.2-vb.5+mc26.1.2")
}
```
