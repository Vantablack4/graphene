...
final class GrapheneDomMouseDispatcher {
    ...
    GrapheneDomMouseDispatcher(GrapheneBrowser browser) {
        Objects.requireNonNull(browser, "browser");
        this.devToolsMethodExecutor = new GrapheneDevToolsMethodExecutor(browser);
    }

    void navigationButtonInteracted(int x, int y, int modifiers, int button, boolean pressed, int clickCount, int buttons) {
